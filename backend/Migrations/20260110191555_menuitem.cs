...
namespace KapeBara.MenuService.Migrations
{
    /// <inheritdoc />
    public partial class menuitem : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MenuItemVariants_Variants_VariantId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MenuItemVariants_MenuItemId_VariantId",
                table: "MenuItemVariants",
                columns: new[] { "MenuItemId", "VariantId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_MenuItemVariants_VariantId",
                table: "MenuItemVariants",
                column: "VariantId");
